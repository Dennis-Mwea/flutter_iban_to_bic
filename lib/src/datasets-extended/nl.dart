...
'AINH': Bank(
    bic: 'AINHNL22',
    code: 'AINH',
    name: "AIRWALLEX (NETHERLANDS) B.V.",
),
'ANDL': Bank(
    bic: 'ANDLNL2A',
    code: 'ANDL',
...
'FROM': Bank(
    bic: 'FROMNL2A',
    code: 'FROM',
    name: "FROMENTY AND CUSTARD E-COMMERCE",
),
'FVLB': Bank(
    bic: 'FVLBNL22',
    code: 'FVLB',
...
'BCDM': Bank(
    bic: 'BCDMNL22',
    code: 'BCDM',
    name: "BANQUE CHAABI DU MAROC * (langdurig) inactief sinds 31 december 2020 *",
),
};
